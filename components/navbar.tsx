...
import { Search, User, ShoppingBag, Heart, TrendingUp, Sparkles, Zap, Gift } from "lucide-react"
          ...
          <div className="flex items-center space-x-4">
            ...
            {isLoggedIn && user ? (
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Button variant="ghost" size="sm" className="cursor-pointer flex items-center space-x-2 hover:bg-accent/50 transition-all duration-200">
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Button size="sm" className="cursor-pointer bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-200">
