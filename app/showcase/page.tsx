    ...
    <div className="min-h-screen p-8 space-y-12">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground">
          Use these classes directly in your components for instant liquid glass effects
        </p>
      </div>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="liquid-glass p-6">
            ...
            <p className="text-sm opacity-80 mb-4">Simple liquid glass effect with subtle corner bending</p>
            <code className="text-xs bg-white/10 px-2 py-1 rounded">.liquid-glass</code>
          </div>

          {/* .liquid-glass-distort */}
          <div className="liquid-glass-distort p-6">
            <h3 className="font-semibold mb-2">Corner Distort</h3>
            <p className="text-sm opacity-80 mb-4">Advanced corner distortion with clip-path bending</p>
            <code className="text-xs bg-white/10 px-2 py-1 rounded">.liquid-glass-distort</code>
          </div>

          {/* .liquid-glass-bento */}
          <div className="liquid-glass-bento p-6">
            <h3 className="font-semibold mb-2">Flowing Bento</h3>
            <p className="text-sm opacity-80 mb-4">Animated liquid flow with organic movement</p>
            <code className="text-xs bg-white/10 px-2 py-1 rounded">.liquid-glass-bento</code>
          </div>

          {/* .liquid-glass-morphic */}
          <div className="liquid-glass-morphic p-6">
            <h3 className="font-semibold mb-2">Morphic Style</h3>
            <p className="text-sm opacity-80 mb-4">Rotating gradients with premium effects</p>
            <code className="text-xs bg-white/10 px-2 py-1 rounded">.liquid-glass-morphic</code>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-md mx-auto">
          <div className="liquid-glass-morphic p-8 text-center">
            ...
            <p className="text-sm opacity-80 mb-6">
              Your action was completed successfully. Notice how the liquid glass effects create depth and authenticity.
            </p>
